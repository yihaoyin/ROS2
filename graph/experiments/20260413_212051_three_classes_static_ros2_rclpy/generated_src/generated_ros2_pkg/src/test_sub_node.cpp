...
class TestSubNodeNode : public rclcpp::Node
{
public:
  TestSubNodeNode()
  : rclcpp::Node("test_sub_node")
  {



    srv_client_0_ = this->create_client<std_srvs::srv::Trigger>("/test_service");
    timer_srv_client_0_ = this->create_wall_timer(1000ms, std::bind(&TestSubNodeNode::on_srv_client_timer_0, this));
  }
...
int main(int argc, char ** argv)
{
  rclcpp::init(argc, argv);
    auto node = std::make_shared<TestSubNodeNode>();
