...
class ClockNodeNode : public rclcpp::Node
{
public:
  ClockNodeNode()
  : rclcpp::Node("clock_node")
  {
    ...
    timer_srv_client_0_ = this->create_wall_timer(1000ms, std::bind(&ClockNodeNode::on_srv_client_timer_0, this));
  }
...
int main(int argc, char ** argv)
{
  rclcpp::init(argc, argv);
    auto node = std::make_shared<ClockNodeNode>();
