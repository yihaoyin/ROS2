...
public:
  ...
  : rclcpp::Node("map_server")
  {
    ...
    srv_server_0_ = this->create_service<std_srvs::srv::Trigger>("/map_server/load_map", std::bind(&MapServerNode::on_srv_server_0, this, std::placeholders::_1, std::placeholders::_2));
    srv_server_1_ = this->create_service<std_srvs::srv::Trigger>("/map_server/map", std::bind(&MapServerNode::on_srv_server_1, this, std::placeholders::_1, std::placeholders::_2));
