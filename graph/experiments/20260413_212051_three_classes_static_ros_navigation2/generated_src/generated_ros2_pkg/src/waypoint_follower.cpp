...
public:
  ...
  : rclcpp::Node("waypoint_follower")
  {
    ...
    srv_client_0_ = this->create_client<std_srvs::srv::Trigger>("/pause");
    srv_client_1_ = this->create_client<std_srvs::srv::Trigger>("/resume");
    timer_srv_client_0_ = this->create_wall_timer(1000ms, std::bind(&WaypointFollowerNode::on_srv_client_timer_0, this));
    timer_srv_client_1_ = this->create_wall_timer(1000ms, std::bind(&WaypointFollowerNode::on_srv_client_timer_1, this));
  }
