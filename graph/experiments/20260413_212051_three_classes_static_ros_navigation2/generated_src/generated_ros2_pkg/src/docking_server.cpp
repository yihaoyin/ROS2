...
public:
  DockingServerNode()
  : rclcpp::Node("docking_server")
  {


    srv_server_0_ = this->create_service<std_srvs::srv::Trigger>("/dock_robot", std::bind(&DockingServerNode::on_srv_server_0, this, std::placeholders::_1, std::placeholders::_2));
    srv_server_1_ = this->create_service<std_srvs::srv::Trigger>("/undock_robot", std::bind(&DockingServerNode::on_srv_server_1, this, std::placeholders::_1, std::placeholders::_2));
