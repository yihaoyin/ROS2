...
public:
  ...
  : rclcpp::Node("amcl")
  {
    ...
    srv_server_0_ = this->create_service<std_srvs::srv::Trigger>("/global_localization", std::bind(&AmclNode::on_srv_server_0, this, std::placeholders::_1, std::placeholders::_2));
    srv_server_1_ = this->create_service<std_srvs::srv::Trigger>("/nomotion_update", std::bind(&AmclNode::on_srv_server_1, this, std::placeholders::_1, std::placeholders::_2));
    srv_server_2_ = this->create_service<std_srvs::srv::Trigger>("/set_initial_pose", std::bind(&AmclNode::on_srv_server_2, this, std::placeholders::_1, std::placeholders::_2));
