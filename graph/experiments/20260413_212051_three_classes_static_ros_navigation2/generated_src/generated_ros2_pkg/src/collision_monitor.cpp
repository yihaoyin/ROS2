...
public:
  ...
  : rclcpp::Node("collision_monitor")
  {
    ...
    srv_server_0_ = this->create_service<std_srvs::srv::Trigger>("/toggle", std::bind(&CollisionMonitorNode::on_srv_server_0, this, std::placeholders::_1, std::placeholders::_2));
...
int main(int argc, char ** argv)
{
  rclcpp::init(argc, argv);
    auto node = std::make_shared<CollisionMonitorNode>();
