...
public:
  ...
  : rclcpp::Node("timer_node")
  {
    ...
    timer_pub_1_ = this->create_wall_timer(500ms, std::bind(&TimerNodeNode::on_pub_timer_1, this));
    timer_srv_client_0_ = this->create_wall_timer(1000ms, std::bind(&TimerNodeNode::on_srv_client_timer_0, this));
  }
