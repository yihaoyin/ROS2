...
class ClockThreadTestingNodeNode : public rclcpp::Node
{
public:
  ClockThreadTestingNodeNode()
  : rclcpp::Node("clock_thread_testing_node")
  {
    ...
    timer_pub_0_ = this->create_wall_timer(500ms, std::bind(&ClockThreadTestingNodeNode::on_pub_timer_0, this));
    timer_srv_client_0_ = this->create_wall_timer(1000ms, std::bind(&ClockThreadTestingNodeNode::on_srv_client_timer_0, this));
  }
...
int main(int argc, char ** argv)
{
  rclcpp::init(argc, argv);
    auto node = std::make_shared<ClockThreadTestingNodeNode>();
