...
class TestComponentFooNode : public rclcpp::Node
{
public:
  TestComponentFooNode()
  : rclcpp::Node("test_component_foo")
  {
    ...
    sub_0_ = this->create_subscription<std_msgs::msg::String>("/service/_service_event", 10, std::bind(&TestComponentFooNode::on_sub_0, this, std::placeholders::_1));
    sub_1_ = this->create_subscription<std_msgs::msg::String>("/test_drop", 10, std::bind(&TestComponentFooNode::on_sub_1, this, std::placeholders::_1));
    sub_2_ = this->create_subscription<std_msgs::msg::String>("/test_topic", 10, std::bind(&TestComponentFooNode::on_sub_2, this, std::placeholders::_1));
    sub_3_ = this->create_subscription<std_msgs::msg::String>("/topic", 10, std::bind(&TestComponentFooNode::on_sub_3, this, std::placeholders::_1));
    sub_4_ = this->create_subscription<std_msgs::msg::String>("/topic_name", 10, std::bind(&TestComponentFooNode::on_sub_4, this, std::placeholders::_1));
    srv_server_0_ = this->create_service<std_srvs::srv::Trigger>("/not_a_service", std::bind(&TestComponentFooNode::on_srv_server_0, this, std::placeholders::_1, std::placeholders::_2));
    srv_server_1_ = this->create_service<std_srvs::srv::Trigger>("/service", std::bind(&TestComponentFooNode::on_srv_server_1, this, std::placeholders::_1, std::placeholders::_2));
    srv_server_2_ = this->create_service<std_srvs::srv::Trigger>("/test_service", std::bind(&TestComponentFooNode::on_srv_server_2, this, std::placeholders::_1, std::placeholders::_2));
    ...
    timer_pub_0_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_0, this));
    timer_pub_1_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_1, this));
    timer_pub_2_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_2, this));
    timer_pub_3_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_3, this));
    timer_pub_4_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_4, this));
    timer_pub_5_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_5, this));
    timer_pub_6_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_6, this));
    timer_pub_7_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_7, this));
    timer_pub_8_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_8, this));
    timer_pub_9_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_9, this));
    timer_pub_10_ = this->create_wall_timer(500ms, std::bind(&TestComponentFooNode::on_pub_timer_10, this));
    timer_srv_client_0_ = this->create_wall_timer(1000ms, std::bind(&TestComponentFooNode::on_srv_client_timer_0, this));
    timer_srv_client_1_ = this->create_wall_timer(1000ms, std::bind(&TestComponentFooNode::on_srv_client_timer_1, this));
    timer_srv_client_2_ = this->create_wall_timer(1000ms, std::bind(&TestComponentFooNode::on_srv_client_timer_2, this));
  }
...
int main(int argc, char ** argv)
{
  rclcpp::init(argc, argv);
    auto node = std::make_shared<TestComponentFooNode>();
