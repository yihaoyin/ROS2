...
public:
  ...
  : rclcpp::Node("clock_publisher")
  {
    ...
    sub_0_ = this->create_subscription<std_msgs::msg::String>("/clock", 10, std::bind(&ClockPublisherNode::on_sub_0, this, std::placeholders::_1));

    srv_client_0_ = this->create_client<std_srvs::srv::Trigger>("/parameter_service");
    timer_pub_0_ = this->create_wall_timer(500ms, std::bind(&ClockPublisherNode::on_pub_timer_0, this));
    timer_srv_client_0_ = this->create_wall_timer(1000ms, std::bind(&ClockPublisherNode::on_srv_client_timer_0, this));
  }
