...
public:
  ServiceServerNode()
  : rclcpp::Node("service_server")
  {


    srv_server_0_ = this->create_service<std_srvs::srv::Trigger>("/compute_sum", std::bind(&ServiceServerNode::on_srv_server_0, this, std::placeholders::_1, std::placeholders::_2));
