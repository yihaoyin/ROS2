...
public:
  ...
  : rclcpp::Node("service_client")
  {
    ...
    sub_0_ = this->create_subscription<std_msgs::msg::String>("/control", 10, std::bind(&ServiceClientNode::on_sub_0, this, std::placeholders::_1));

    srv_client_0_ = this->create_client<std_srvs::srv::Trigger>("/compute_sum");
    timer_srv_client_0_ = this->create_wall_timer(1000ms, std::bind(&ServiceClientNode::on_srv_client_timer_0, this));
  }
